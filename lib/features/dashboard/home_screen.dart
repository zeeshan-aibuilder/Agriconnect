...
import 'dart:async';
// import '../listings/listing_detail_screen.dart'; // Uncomment if used
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final Map<String, Map<String, dynamic>> _mandiGraphData = {
    'Wheat': {
      ...
      'trend': '+2.4%',
      'isUp': true,
      'data': [0.4, 0.6, 0.5, 0.8, 0.7, 0.9, 1.0],
    },
    'Apples': {
      'price': 'Rs. 4,500',
      'unit': '/ Carton',
      'trend': '+5.1%',
      'isUp': true,
      'data': [0.3, 0.4, 0.4, 0.6, 0.8, 0.9, 0.85],
    },
    'Rice': {
      'price': 'Rs. 8,500',
      'unit': '/ 40kg',
      'trend': '-1.2%',
      'isUp': false,
      'data': [1.0, 0.9, 0.8, 0.85, 0.7, 0.6, 0.65],
    },
    'Cotton': {
      'price': 'Rs. 9,100',
      'unit': '/ 40kg',
      'trend': '+0.5%',
      'isUp': true,
      'data': [0.7, 0.75, 0.7, 0.8, 0.85, 0.8, 0.9],
    },
    'Corn': {
      'price': 'Rs. 3,000',
      'unit': '/ 40kg',
      'trend': '-0.8%',
      'isUp': false,
      'data': [0.6, 0.8, 0.9, 0.7, 0.6, 0.5, 0.4],
    },
  };
  ...
  final List<Map<String, dynamic>> _promos = [
    {
      'title': 'Sona Urea - FFC 🌾',
      'subtitle': 'Bumper fasal ki zamanat! Order bulk Sona Urea today.',
    ...
    {
      'title': 'Millat Tractors 🚜',
      'subtitle': 'Massey Ferguson 385. Book now on easy installment plans.',
    ...
    {
      'title': 'Engro Zarkhez 🌿',
      'subtitle': 'Pakistan\'s premium balanced fertilizer for maximum yield.',
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: _StatCard(
                        title: isFarmer ? 'Active Listings' : 'Demands',
                        value: '12',
              ...
              Row(
                ...
                children: List.generate(
                  ...
                  (index) => AnimatedContainer(
                    ...
                    height: 6,
                    decoration: BoxDecoration(
                      color: _currentPromoIndex == index ? _ink : _hairline,
                ...
                child: Row(
                  ...
                  children: [
                    Icon(
                      ...
                      color: isUp ? _primaryGreen : const Color(0xFFEF4444),
                      size: 14,
                    ),
                    const SizedBox(width: 4),
                    Text(
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(
                icon,
                color: isClosed ? _muted : statusColor,
                size: 24,
              ),
            ),
            const SizedBox(width: 16),
